package flandrelaevatain.gui.upgrader.packet;
...
public class UpgraderPacketHandler implements IPacketHandler
{
	public static Packet getPacket(TileUpgrader tile)
	{
	...
	public void onPacketData(INetworkManager manager, Packet250CustomPayload packet, Player player)
	{
		if(packet.channel.equals(FlandreLaevatain.ModChannel))
		{
			...
			if (tileentity != null)
			{
				if (tileentity instanceof TileUpgrader)
				{
					((TileUpgrader)tileentity).readToPacket(data);
				}
			}
		}
	}
